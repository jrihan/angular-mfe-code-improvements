...
import { BuscarResseguradorResponseEntityFactory } from './buscar_ressegurador_response.factory';

export class ListarResseguradoresContentEntityFactory {
  static create(
    override?: Partial<Omit<ListagemBuscarResseguradorResponseEntity, 'copyWith'>>
  ): ListagemBuscarResseguradorResponseEntity {
...
export class ListarResseguradoresResponseEntityFactory {
  static create(
    ...
    const content =
      override?.content ?? ListarResseguradoresContentEntityFactory.createList(size);
